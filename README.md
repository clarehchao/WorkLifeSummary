...
- If not thinking about drawing fuzzy and cute animals or being out in the nature, I worked on [a recent project on data visualization using Python Plotly](https://github.com/clarehchao/Pulse_Dashboard) as I learn how to visualize and present data more effectively and intentionally.
