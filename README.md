...
1. With the large amount of breast CT images, I characterized the beast anatomny in many ways including
  ...
  - See more details in ![Skin Thickess using Breast CT Images](/linked_files/Publications/SkinTMammoDose_2008_Huang.pdf,'oh'), [Breast Anatomical Metrics Using Breast CT Images](linked_files/Publications/BreastMetrics_2011_Huang.pdf), and [Chapter 2 of my PhD dissertation](linked_files/Disseration_UCstyleClass_SHuang.pdf)
